"""
Functions needed to draw a regulation NBA basketball court
...
def division_line(full_surf = True, rotate = False, rotation_dir = 'ccw'):
    ...
    the division line as in the court diagram on page 8 of the NBA rule book
...
def endline_sideline(full_surf = True, rotate = False, rotation_dir = 'ccw'):
    ...
    diagram on page 8 of the NBA rule book, as well as the hash marks on the
    sides of the court
...
def free_throw_lane(full_surf = True, rotate = False, rotation_dir = 'ccw',
    ...
    the NBA rule book. This free-throw lane is required for all teams. This
...
def free_throw_circle(full_surf = True, rotate = False, rotation_dir = 'ccw'):
    ...
    as specified in page 8 of the NBA rule book
...
def three_point_line(full_surf = True, rotate = False, rotation_dir = 'ccw'):
    ...
    as specified in the NBA rule book
...
def restricted_area_arc(full_surf = True, rotate = False,
    ...
    arcs as specified in the NBA rule book
...
def backboard(full_surf = True, rotate = False, rotation_dir = 'ccw'):
    ...
    specified in the court diagram of the NBA rule book
...
def goal(full_surf = True, rotate = False, rotation_dir = 'ccw'):
    ...
    in the court diagram of the NBA rule book
...
def painted_area(full_surf = True, rotate = False, rotation_dir = 'ccw'):
    """
    Generate the dataframe for the points that comprise the bounding box of the
    free throw lane as specified in the court diagram of the NBA rule book
